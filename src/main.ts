...
type Page = 'home' | 'basic' | 'expert' | 'result' | 'library';
...
function render() { if (page === 'home') renderHome(); else if (page === 'result') renderResult(); else if (page === 'library') renderLibrary(); else renderGenerator(page); }
render();
